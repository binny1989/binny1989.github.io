...
Ads.prototype.requestAds = function(adTagUrl) {
  ...
  this.adsLoadertimeout_= setTimeout(function() {
  ...
  if (this.adsManager_) {
    ...
    this.onAdError_({
                        getError: function () { return e.stack; }
                    });
   }
...
Ads.prototype.onAdsManagerLoaded_ = function(adsManagerLoadedEvent) {
  ...
  adsRenderingSettings.enabledPreloading;
...
Ads.prototype.onAdEvent_ = function(adEvent) {
  ...
  if (adEvent.type == google.ima.AdEvent.Type.CLICK) {
    ...
    var ad = adEvent.getAd();
     this.application_.log("AdType:" +ad.getContentType());

    if (!ad.isLinear())
    {
      this.application_.log("AD is not LINEAR AD")
      this.onContentResumeRequested_();
    }
    else
  {
    this.application_.log("AD is LINEAR AD")
  }
  }
