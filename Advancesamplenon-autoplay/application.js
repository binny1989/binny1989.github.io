...
var Application = function() {
  ...
  console.log(document.getElementById('tagText'));
  this.sampleAdTag_ = document.getElementById('sampleAdTag');
  console.log(document.getElementById('sampleAdTag'));
...
console.log(Application.prototype.log);
...
Application.prototype.onClick_ = function() {
  if (!this.adsDone_) {
    this.adTagUrl_ =  'https://rtr.innovid.com/r1.56e985418350a6.03896462;cb=610877523';
